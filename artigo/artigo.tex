...
\underline{comportamento conservador} (R1$_{OP} \approx 0{,}93$,
...
with \emph{extreme conservatism} (R1$_{OP} \approx 0.93$, $\Delta \mathrm{F} \leq +4.2$)
...
(ROUGE-1 até 0,74, SARI até 55,5), mas com
\underline{comportamento conservador extremo}
...
superiores; (iii) realizar \textbf{avaliação com juízes humanos}
(prioritária) para calibrar as métricas automáticas e o LLM-judge,
