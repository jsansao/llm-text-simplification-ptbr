...
modelos ajustados em domínio, além de baixa concordância entre juízes
automáticos para modelos baseados em prompting.
\end{resumo}
...
%
Este trabalho não conduziu uma validação humana em escala: a
infraestrutura de anotação humana presente no repositório
(\texttt{human\_eval/}) não foi integrada ao pipeline experimental
deste estudo. Como os juízes automáticos discordam fortemente
