...
sensibilidade qualitativa (sem rec\'alculo completo das
m\'etricas) indica que a remo\c{c}\~ao do par \#16 n\~ao altera
qualitativamente as conclus\~oes deste trabalho: o par aparece
como outlier em todos os modelos (R1 m\'edio $= 0{,}019$), com
impacto dilu\'\i{}do pela corre\c{c}\~ao de m\'ultiplas
compara\c{c}\~oes (Holm-Bonferroni).}
...
($\alpha$ médio $0{,}18$), a calibração das métricas automáticas
...
($\alpha = 0{,}18$ em média); (iv) investigar se prompts
...
português acompanham o repositório. O commit de referência
correspondente a esta versão do manuscrito é o de hash
\texttt{5de9157} (24 jun. 2026), com versões posteriores mantendo
